...
public class TripController {
    ...
    public Trip search(Date arrivalDate, Date departureDate, int noOfTravelers, String flightDeparture, int tourBudget,
            int flightBudget, int hotelBudget) {
        try {
            testInputs(arrivalDate, departureDate, noOfTravelers, flightDeparture, tourBudget, flightBudget,
                    hotelBudget);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public Trip search(Date arrivalDate, Date departureDate, int noOfTravelers, String flightDeparture,
            int totalBudget) {
        return search(arrivalDate, departureDate, noOfTravelers, flightDeparture, totalBudget, totalBudget,
                totalBudget);
    }
    ...
    public void testInputs(Date arrivalDate, Date departureDate, int noOfTravelers, String flightDeparture,
            int tourBudget, int flightBudget, int hotelBudget) throws Exception {
