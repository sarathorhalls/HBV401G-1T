...
public class FlightController {
    ...
    private ArrayList<FlightBooking> bookingList = new ArrayList<>();
     ...
     * @throws Exception
     */
    public ArrayList<FlightBooking> findBooking(String SSN) throws Exception {
     ...
     * @throws Exception
     */
    public ArrayList<FlightBooking> findBooking(String SSN, String FlightID) throws Exception {
        bookingList.clear();
        if (FlightID != null){
            // Select M/ FlightID
            Class.forName("org.sqlite.JDBC");
            ...
            try {
                ...
                while (rs.next()) {
                    LocalDateTime temp2 = LocalDateTime.parse(rs.getString("departureTime"), formatter);
                    bookingList.add(new FlightBooking(rs.getString("SSN"), rs.getString("FlightID"),temp2,
            ...
            for (FlightBooking item : bookingList) {
                System.out.println(item.toString());
            }
