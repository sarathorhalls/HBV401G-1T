...
public class TestTripController {
    ...
    public void testIncorrectArrivalDate() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2021, JAN_18_2023, 5, "Miami", 450000, 450000, 450000));
        assertEquals("Arrival date cannot be earlier than today.", exception.getMessage());
    }

    @Test
    public void testIncorrectDepartureDate() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_18_2023, JAN_01_2023, 5, "Miami", 450000, 450000, 450000));
    ...
    public void testIncorrectNoOfTravelers() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 0, "Miami", 450000, 450000, 450000));
        assertEquals("There must be atleast one traveler.", exception.getMessage());
    }

    @Test
    public void testLessThanZeroNoOfTravelers() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, -5, "Miami", 450000, 450000, 450000));
        assertEquals("There must be atleast one traveler.", exception.getMessage());
    }

    @Test
    public void testIncorrectDeparted() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "", 450000, 450000, 450000));
        assertEquals("No departure selected.", exception.getMessage());
    }

    @Test
    public void testNullDeparted() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, null, 450000, 450000, 450000));
        assertEquals(null, exception.getMessage());
    }

    @Test
    public void testIncorrectTourBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", 0, 450000, 450000));
        assertEquals("Tour budget cannot be less than 1.", exception.getMessage());
    }

    @Test
    public void testIncorrectFlightBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", 450000, 0, 450000));
        assertEquals("Flight budget cannot be less than 1.", exception.getMessage());
    }

    @Test
    public void testIncorrectHotelBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", 450000, 450000, 0));
        assertEquals("Hotel budget cannot be less than 1.", exception.getMessage());
    }
    
    @Test
    public void testLessThanZeroTourBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", -5, 450000, 450000));
        assertEquals("Tour budget cannot be less than 1.", exception.getMessage());
    }

    @Test
    public void testLessThanZeroFlightBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", 450000, -5, 450000));
        assertEquals("Flight budget cannot be less than 1.", exception.getMessage());
    }

    @Test
    public void testLessThanZeroHotelBudget() {
        Throwable exception = assertThrows(Exception.class, () -> tripController.testInputs(JAN_01_2023, JAN_18_2023, 5, "Miami", 450000, 450000, -5));
        assertEquals("Hotel budget cannot be less than 1.", exception.getMessage());
    }
    @Test
